...
<html>
    ...
    <div>
        <a href="#" id="upload-trigger" onClick="javascript:postFeed2();">File Upload!</a>
                        ...
                        <table class="table stacktable" style="width: 100%" id="tabla1" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"><p> <a  id="foto "style="color: orange" onclick="javascript:postFeed2('${x.imagen}','${x.descripcion}')" /><strong>Postear facebook</strong></a></p>  </td>
